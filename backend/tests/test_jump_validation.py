...
def test_jump_target_not_exist_should_fail(api_client):
    ...
    refs = convert_to_refs(ctx.db, ctx.auth.user_id, raw_questions)
    update_resp = client.put(f"/surveys/{survey_id}", json={"questions": refs})
...
def test_cycle_jump_should_fail(api_client):
    ...
    raw_questions = [
        ...
        {"question_id": "q2", "type": "text_input", "title": "题目2", "required": True, "order": 2},
        {
            "question_id": "q3",
            "type": "single_choice",
            "title": "题目3",
        ...
        {"question_id": "q4", "type": "text_input", "title": "题目4", "required": True, "order": 4},
        {
            "question_id": "q5",
            "type": "single_choice",
            "title": "题目5",
...
def test_valid_jump_logic_should_succeed(api_client):
    ...
    raw_questions = [
        ...
        {"question_id": "q4", "type": "text_input", "title": "题目4", "required": True, "order": 4},
        {"question_id": "q5", "type": "text_input", "title": "题目5", "required": True, "order": 5},
    ]
    refs = convert_to_refs(ctx.db, ctx.auth.user_id, raw_questions)
    update_resp = client.put(f"/surveys/{survey_id}", json={"questions": refs})
...
def test_multiple_rules_with_different_targets_should_succeed(api_client):
    ...
    raw_questions = [
        ...
        {"question_id": "q2", "type": "text_input", "title": "题目2", "required": True, "order": 2},
        {"question_id": "q3", "type": "text_input", "title": "题目3", "required": True, "order": 3},
        {"question_id": "q4", "type": "text_input", "title": "题目4", "required": True, "order": 4},
    ]
    refs = convert_to_refs(ctx.db, ctx.auth.user_id, raw_questions)
    update_resp = client.put(f"/surveys/{survey_id}", json={"questions": refs})
